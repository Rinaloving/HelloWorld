...
namespace TestPaging
{
    ...
    public partial class PagerControl : UserControl
    {
        ...
        private void DrawControl(bool callEvent)
        {
            ...
            lblCurrentPage.Text = "当前页：" + PageIndex + "/" + lblPageCount1.Text;
            lblPageCount.Text = "共" + GetPageCount() + " 页";
            lblTotalCount.Text = "共"+RecordCount+" 条";
        ...
        private void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //TryParse 函数，将字符串转化成等效的整数，返回bool型，
                //判断是否转换成功。输入除数字之外的字符是转换不成功的
                if (num > PageCount) //输入数量大于最大页数时，文本框自动显示最大页数
                {
                    txtPageNum.Text = GetPageCount().ToString();
                }
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtPageSize1_TextChanged(object sender, EventArgs e)
        {
            int num = 0;
            //输入不符合规范时，默认设置为4
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtPageSize1_Leave(object sender, EventArgs e)
        {
            if (isTextChanged)
            {
                isTextChanged = false;
        ...
        private void txtPageSize1_SizeChanged(object sender, EventArgs e)
        {
